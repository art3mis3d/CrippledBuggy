...
[CreateAssetMenu(fileName = "RotateAction", menuName = "State Machines/Actions/Alpha/Rotate")]
public class AlphaRotateActionSO : StateActionSO<RotateAction>
{
...
public class RotateAction : StateAction
{
	...
	private AlphaRotateActionSO _originSO => (AlphaRotateActionSO)base.OriginSO; // The SO this StateAction spawned from
