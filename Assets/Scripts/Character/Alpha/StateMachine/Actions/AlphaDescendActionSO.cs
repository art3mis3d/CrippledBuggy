...
[CreateAssetMenu(menuName = "State Machines/Actions/Alpha/Descend")]
public class AlphaDescendActionSO : StateActionSO<AlphaDescendAction> { }

public class AlphaDescendAction : StateAction
{
