...
public class FadeChannelSO : DescriptionBaseSO
{
	...
	/// <summary>
	/// Fade helper function to simplify usage. Fades the screen out to the specified color.
	/// </summary>
	/// <param name="duration">How long it takes to the image to fade out.</param>
	...
	/// <summary>
	/// Generic fade function. Communicates with <seealso cref="FaceController"/>.
	/// </summary>
	...
	/// <param name="color">Target color for the image to reach. Disregarded when fading in.</param>
